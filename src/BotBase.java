...
public class BotBase extends Bot {
    ...
    public void stickerMessage(Message message) {
        ...
        sendMessage(mts);
        StickerReferenceToSend stickerReferenceToSend = new StickerReferenceToSend(message.getFrom().getId(), "CAACAgIAAxkBAAOnX6P-IP30CrbmJOeuybMO91TiCaIAApIAAxZCawqkSq0TfzyEMR4E");
